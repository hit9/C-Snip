...
void *heap_del(struct heap *heap, size_t idx);     /* O(log(N)) */
void *heap_replace(struct heap *heap, void *data); /* O(log(N)) */
void heap_siftdown(struct heap *heap, size_t start_idx,
                   size_t idx);                  /* O(logN) */
